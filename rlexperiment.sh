...
#java -classpath /media/siva/OS/Lancaster/Dissertation/git/microrts-burlap-integration/bin:/media/siva/OS/Lancaster/Dissertation/git/microrts-burlap-integration/lib/*  rl.RLExperiment "$@"
